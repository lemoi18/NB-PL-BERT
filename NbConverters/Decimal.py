...
class Decimal:
    ...
    - 6 Add "komma" to output if there is a decimal
    - 7 Add "null" only if the decimal is "0", and there is a number in front of the dot, and there is no suffix (if there is a decimal)
    ...
    Edge cases:
    3.66E-49 -> tre komma seks seks ganger ti til minus førtini
    """
    def __init__(self):
        super().__init__()
